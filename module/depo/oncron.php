...
{
	useLib('depo');
	$statJson = json_encode(depoGetStat(), JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES);
	if ($statJson === false || file_put_contents('tpl_c/stat.dat', $statJson, LOCK_EX) === false)
		xAddToLog('Unable to write tpl_c/stat.dat', 'depo');
}
