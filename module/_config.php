...
$_rwlinks = array(
	...
	'api/v1/balance' => array('api/v1/balance'),
	'api/v1/deposit' => array('api/v1/deposit'),
	'api/v1/withdraw' => array('api/v1/withdraw'),
	'api/v1/operations' => array('api/v1/operations'),
    ...
    'system/admin/setup_api' => array('admin/setup/api', 'admin' => '{!ru!}Настройки{!en!}Settings{!!}/API'),
    ...
    'translations/admin' => array('admin/translations', 'admin' => '{!ru!}Настройки{!en!}Settings{!!}/{!ru!}Переводы{!en!}Translations'),
    ...
    'message/admin/messages' => array('admin/messages', 'admin' => '{!ru!}Сообщения{!en!}Messages{!!}/{!ru!}Диалоги{!en!}Conversations'),
    'message/admin/message' => array('admin/message', 'admin' => '{!ru!}Сообщения{!en!}Messages{!!}/-'),
    'message/admin/setup' => array('admin/message/setup', 'admin' => '{!ru!}Сообщения{!en!}Messages{!!}/{!ru!}Настройки{!en!}Settings'),
